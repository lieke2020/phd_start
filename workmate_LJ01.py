...
#The memory projection is the size of the whole memory module (nS)
...
class WorkMATe(object):
    ...
    def update_weights(self):
        ...
        wt_pairs = ( ( self.W_hl, self.Tag_W_hl ), 
                     ...
                     ( self.W_Sl, self.Tag_W_Sl) ) #added by LJC
    ...
    def update_traces(self):
        ...
        self.Trace_W_hl += self.l.reshape(1, self.x.size) # this includes trace for bias
