...
Agent with learned layer L and S
...
class WorkMATe(object):
    ...
    def __init__(self, env=None, nhidden=20, nblocks=2, block_size=15):
        ...
        self.sigmoid_offset = sigmoid_offset = 0
    ...
    def construct_input(self):
        ...
        # Compute match value at level latent layer:
        ...
        self.l_out = np.r_ [self.l_sens, matches, 1.0]
        return
    ...
    def update_weights(self):
        ...
        #self.W_hS += self.beta2 * self.delta * self.Tag_W_hS
