# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 10:01:46 2020

This agent is to implement the learning of the latent layer onto LJ02.
The latent layer before was a fixed random projection and the memory 
projection is now set 1on1 with the size of one block.
